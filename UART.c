...
//read the uart to a string and only return the string if a line feed character is received, otherwise return a empty string but keep the string in memory for the next reading
char* readLine() {
